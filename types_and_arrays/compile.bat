...
REM   python -m numpy.f2py -m demo -h demo.pyf python_data_exchange.f90 data_reader.f90 main.f90
...
python -m numpy.f2py -c -m demo demo.pyf types.f90 my_data.f90 python_data_exchange.f90 data_reader.f90 main.f90
move demo\.libs\* .