...
REM   python -m numpy.f2py -m demo -h demo.pyf types.f90 my_data.f90 data_reader.f90 demo.f90
...
python -m numpy.f2py -c -m demo demo.pyf types.o my_data.f90 data_reader.f90 demo.f90
move demo\.libs\* .